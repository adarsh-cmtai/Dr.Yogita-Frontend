...
function PaymentStatusHandler({
  ...
  useEffect(() => {
    ...
    if (razorpayStatus && planIdFromQuery) {
  ...
  }, [searchParams, allNutritionPlans, router, openThankYouModal, openPaymentFailedModal, setIsLoadingStatusCheck, setSelectedPlanForModal]);
  ...
  useEffect(() => {
    const fetchNutritionPlans = async () => {
      ...
      try {
        ...
        console.log("this is nutrition data", data);
        if (data.success) {
                    ...
                    <div className="p-5 flex flex-col flex-grow">
                      ...
                      <div className="flex items-center justify-between mt-auto pt-4 border-t border-gray-200">
                        ...
                        <Button
                          ...
                          disabled={!plan.razorpayPaymentLink}
                        >
